...
import anhdep2 from "../../assets/images/nhadep.png";
import anhdep3 from "../../assets/images/vinpearl.jpg";
import anhdep4 from "../../assets/images/vinpearlland.jpg";
...
const items = [anhdep, anhdep2, anhdep3, anhdep4];
function da() {
	return;
}
function DisplayData({ parkData, items }) {
	return (
		<Grid container spacing={3} sx={{ mt: "30vh", mb: "20vh" }}>
			<Grid item xs={2} sm={2}></Grid>
			<Grid item xs={8} sm={8}>
				<Grid container spacing={3}>
					{parkData.features.map((park) => (
						<Grid key={park.properties.PARK_ID} item xs={12} sm={6} md={4} lg={3}>
							<Card sx={{ width: "100%" }}>
								<CarouselFunction items={items} />

								<Button>
									<CardContent>
										<Typography gutterBottom>NHÀ TRỌ NGUYÊN CĂN</Typography>
										<Typography variant='body2' color='text.secondary' textTransform='none'>
											Đc: số 18 Phạm Hùng, phường Mỹ Đình 2, Nam Từ Liêm, Hà Nội
										</Typography>
									</CardContent>
								</Button>
							</Card>
...
export default function HomeList() {
	return <DisplayData parkData={parkData} items={items} />;
}
