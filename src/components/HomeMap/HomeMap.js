...
import { MarkerOnClick, MarkerLocationPosition, DisplayData } from "../MapFunctions/mapfunctions";
...
export default function HomeMap() {
	...
	return (
		<>
			<MapContainer center={[21.024, 105.84]} zoom={16} closePopupOnClick whenCreated={setMap}>
				<LayersControl position='topright'>
					...
					<MarkerOnClick />
					<MarkerLocationPosition position={position} />
					<DisplayData parkData={parkData} />
				</LayersControl>
			</MapContainer>
		</>
	);
...
/*
// Layer các dạng bản đồ:
//OpenStreetMap
						//attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
						//url='https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png'
						// Tham khảo nhà cung cấp: https://github.com/leaflet-extras/leaflet-providers
						//Google
						//url='https://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}' //satellite
						//url='http://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}' //street
						//url='http://{s}.google.com/vt/lyrs=s,h&x={x}&y={y}&z={z}' //hybrid
...
// Want to render blinking
export default function App() {
	const [activePark, setActivePark] = useState(null);
	const [rendere, setRendere] = useState(true);
